...
.PHONY: all test clean deploy fund help install snapshot format anvil deployMood zktest
...
zkdeploy: 
	@forge create src/BasicNFT:BasicNFT --rpc-url http://127.0.0.1:8011 --private-key $(DEFAULT_ZKSYNC_LOCAL_KEY) --legacy --zksync